...
class plugin_iirs_userPostList {
     ...
     *
     * @global $member 用户信息
     * @return string 2个链接，用于给用户查看该人的回复过的帖子和主题
     */
